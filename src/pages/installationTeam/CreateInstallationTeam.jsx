...
const EXISTING_USERS = [
  { value: 'u1', label: 'John Doe', email: 'john@example.com', phone: '1234567890' },
  { value: 'u2', label: 'Jane Smith', email: 'jane@example.com', phone: '0987654321' },
  { value: 'u3', label: 'Bob Johnson', email: 'bob@example.com', phone: '1122334455' },
];
...
function CreateInstallationTeam() {
  ...
  const [formData, setFormData] = useState({
    teamName: '',
    teamCode: 'TEAM-' + Math.floor(Math.random() * 10000), // Auto-generated
    assignedPlant: 'grid-001', // Pre-selected or passed via context
    status: 'active',
    
    // Team Lead
    teamLeadMode: 'existing', // 'existing' or 'new'
    teamLeadId: '',
    leadName: '',
    leadEmail: '',
    leadPhone: '',
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField name="teamName" label="Team Name" required touched={touched} errors={errors}>
                        <div className="relative">
                            ...
                            <input type="text" name="teamName" value={formData.teamName} onChange={handleChange} placeholder="e.g., Alpha Squad" className={getInputClassName('teamName', touched, errors)} />
                        </div>
                    </FormField>
                    ...
                    <div className="relative">
                       <Select
                         ...
                         options={PLANTS} // In real app, make read-only if fixed context
                         onChange={handleChange} // If allowed to change
                         icon={Briefcase}
                         disabled={true} // Read-only as per spec
                       />
